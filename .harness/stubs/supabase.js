...
const TABLES = {
  ...
  cibles: [
    ...
    // c3/c4/c5 partagent le même dirigeant : cas « groupe » (seuil à 3), avec une
    // société déjà écartée — elle doit rester comptée dans le groupe.
    { id: 'c4', type: 'supermarche_dirigeant', siren: '572165264', denomination: 'DELATTRE DISTRIBUTION SUD', naf: '47.11D',
      region: '11', ville: 'MONTREUIL', code_postal: '93100', adresse: '8 RUE DE PARIS 93100 MONTREUIL',
      nb_etablissements: 1, effectif: '12', date_creation: '1996-04-02', statut: 'a_qualifier',
      dirigeant_nom: 'PHILIPPE DELATTRE', dirigeant_naissance: '1958-01', dirigeant_qualite: 'Gérant',
      via_holding: 'ELADIS HOLDING', releve_possible: false,
      co_dirigeants: [{ n: 'PHILIPPE DELATTRE', d: '1958-01', q: 'Gérant' }],
      ca: 6420800, resultat: 190400, annee_finances: '2024', score: 71, latitude: 48.8638, longitude: 2.4477, geo_approx: false,
      score_detail: { 'âge du dirigeant effectif (30)': 22, 'absence de relève identifiée (25)': 25,
        'ancienneté de la société (15)': 12, 'taille — CA connu (15)': 10, 'effectif salarié (10)': 10, 'multi-établissements (5)': 0 },
      lien: 'https://annuaire-entreprises.data.gouv.fr/entreprise/572165264', detecte_le: '2026-08-21T21:00:00Z' },
    { id: 'c5', type: 'supermarche_dirigeant', siren: '572165272', denomination: 'ELADIS PROXI', naf: '47.11C',
      region: '11', ville: 'VINCENNES', code_postal: '94300', adresse: '22 AVENUE DE PARIS 94300 VINCENNES',
      nb_etablissements: 1, effectif: '11', date_creation: '2004-09-14', statut: 'ecartee',
      dirigeant_nom: 'PHILIPPE DELATTRE', dirigeant_naissance: '1958-01', dirigeant_qualite: 'Gérant',
      via_holding: 'ELADIS HOLDING', releve_possible: true,
      co_dirigeants: [{ n: 'ADRIEN DELATTRE', d: '1989-11', q: 'Gérant' }, { n: 'PHILIPPE DELATTRE', d: '1958-01', q: 'Gérant' }],
      ca: 3110200, resultat: 84100, annee_finances: '2024', score: 58, latitude: 48.8478, longitude: 2.4372, geo_approx: false,
      score_detail: { 'âge du dirigeant effectif (30)': 22, 'absence de relève identifiée (25)': 5,
        'ancienneté de la société (15)': 8, 'taille — CA connu (15)': 8, 'effectif salarié (10)': 10, 'multi-établissements (5)': 0 },
      lien: 'https://annuaire-entreprises.data.gouv.fr/entreprise/572165272', detecte_le: '2026-08-21T21:00:00Z' },
  ],
  cibles_commentaires: [
    { id: 'cc1', cible_id: 'c2', contenu: "Appelé le magasin : le gérant est ouvert à discuter après la rentrée.", cree_le: '2026-08-21T18:00:00Z', auteur: 'u1', profiles: { full_name: 'Anthony B.' } },
  ],
